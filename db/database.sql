...
(2, 1, 1, 11, 'Macintosh Plus', 79.99, true, 14042024, 'desktop,retro', 'Decent', 'The white components are a little yellowed due to the passing of the years', false, 'Large',49.99, 3, '/../images/products/macintoshplus.jpg'),
(3, 3, 4, 10, 'Record Deck', 279.99, true, 14042024, 'sound,retro,music', 'Very Good', 'a milestone in music, nothing better to listen to music than a record player', false, 'Large',49.99,27, '/../images/products/GiraDiscosThorensTD125MKII.jpg'),
