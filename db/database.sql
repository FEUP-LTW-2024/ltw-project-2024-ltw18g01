...
(13, 4, 4, 13, 'CD Player', 19.99, false,03052024, 'music,retro,album', 'Decent', 'Experience the timeless joy of music with this sleek and reliable CD player, perfect for enjoying your favorite albums with pristine sound quality. Its compact design and easy-to-use controls make it a versatile addition to any audio setup.','Small',19.99,'/../images/products/megadrive.jpg'),
(14, 1, 4, 15, 'Deftones - Around the fur', 11.99, true, 04052024, 'music,retro,album', 'Very Good', 'Powerful and visceral album that showcases their signature blend of heavy riffs, ethereal melodies, and emotional intensity. With tracks like "My Own Summer (Shove It)" and "Be Quiet and Drive (Far Away)," it captures the raw energy and complexity that define the Deftones sound, making it a must-have for fans of alternative metal.','Small',19.99,'/../images/products/deftonesvinyl.jpg');
